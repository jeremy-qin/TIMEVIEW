...
python benchmark.py --datasets airfoil_log flchain_1000 stress-strain-lot-max-0.2 --baselines TTS XGB GAM --n_trials $n_trials --n_tune $n_tune --seed 0 --device gpu --n_basis 9 --rnn_type lstm
